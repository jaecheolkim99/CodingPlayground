...
"""
class Solution(object):
    def checkResult(self, candidates, target, idx, lst, result):
        for i in range(idx, len(candidates)):
            ...
            self.checkResult(candidates, next_target, i, lst + [candidates[i]], result)
    ...
    def combinationSum(self, candidates, target):
        ...
        self.checkResult(candidates, target, 0, [], result)
